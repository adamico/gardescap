...
describe Period do
  describe "#mois" do
    it "should return an array of 'month-Year' for each month in period" do
      Period.new(starts_at: "2014-05-01", ends_at: "2014-08-31").mois.should == ["mai-2014", "juin-2014", "juillet-2014", "août-2014"]
    end
  end
